...
public class MainActivity extends ActionBarActivity implements
    ...
    GooglePlaceVenues googlePlaceVenues;
    ...
    private GooglePlaceVenues.GooglePlaceVenuesCallBack mGooglePlaceVenuesCallBack = new GooglePlaceVenues.GooglePlaceVenuesCallBack() {
        ...
        public void onPostExecute(List<String> result) {
            if (result != null && result.size() > 0) {
                ...
                mGpsWrapper.setVisibility(View.GONE);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStartUpdatesButton = (Button) findViewById(R.id.location_updates_button);
        mLocationListView = (ListView) findViewById(R.id.location_list_view);
        mGpsWrapper = findViewById(R.id.gps_wrapper);
